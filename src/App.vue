<template>
  <main class="h-auto flex flex-col">
    <app-testimonial
      :imgSrc="imgSrc"
    ...
    <app-testimonial
      ...
      The first line of Lorem Ipsum, \'Lorem ipsum dolor sit amet..\', comes from a line in section 1.10.32.The standard chunk of Lorem Ipsum used since the 1500s is reproduced below for those interested. Sections 1.10.32 and 1.10.33 from 'de Finibus Bonorum et Malorum' 
...
import imgSrc from './assets/michael-dam-mEZ3PoFGs_k-unsplash.jpg'

export default {
  name: 'App',
  components: { AppFooter, AppTestimonial },
  data() {
